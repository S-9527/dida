...
describe("validator", () => {
  describe("validator username", () => {
    ...
    it.each(["12345", "1234"])(
      "should return false when username is %i because its length <=5",
      (i) => {
  ...
  describe("validator password", () => {
    ...
    it.each(["123456", "12345"])(
      "should return false when password is %i because its length <=6",
      (i) => {
    ...
    it("should return false when password length >=30", () => {
      expect(validatePasswordLength("012345678901234567890123456789")).toBe(
        false,
      );
      expect(validatePasswordLength("0123456789012345678901234567890")).toBe(
        false,
      );
    });
  });
